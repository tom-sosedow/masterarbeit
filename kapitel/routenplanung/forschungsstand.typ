...
Zur Bestimmung einer anforderungsgemäßen Reihenfolge, in der die @UE angefahren werden, können unterschiedliche Verfahren herangezogen werden. Im aktuellen Ansatz des @CBT wird die Route für den Roboterarm direkt aus der Reihenfolge abgeleitet, in der die @UE in die Ergebnisliste der Positionsbestimmung eingefügt werden.
