...
Diese Eigenschaft ist wichtig, damit später die verschiedenen Lösungen anhand ihrer Kosten geordnet und in Relation zueinander betrachtet werden können. 
...
#figure(
  table(
    ...
    table.header(
      repeat: true,
      [Wand], [Breite], [Höhe], [Türhöhe], [Türbreite], [Türversatz], [Padding] ,[Anzahl UE]
    ),
    $w_1$, [80], [55], [25], [35], [30], [0], [30],
    $w_2$, [80], [55], [35], [25], [25], [0], [32],
...
// Seeds
Für nicht-deterministische Methoden, welche einen Zufallsgenerator benötigen, werden zwei selbstgewählte Initialisierungswerte $s_1 = 1234$ und $s_2 = 84273915$ festgelegt, um die Ergebnisse in diesen Testläufen vergleichbar zu halten. Zum Vergleich derer werden ebenfalls je Wert vier Testläufe durchgeführt.
