...
Um einen passenden Ansatz bestimmen zu können, müssen Bewertungskriterien festgelegt werden. Anhand derer werden die betrachteten exakten und heuristischen Methoden bewertet und untereinander ihre Anwendbarkeit und Eignung zur Lösung der zuvor definierten Problemstellung systematisch zu vergleichen. 

Um die Ergebnisse vergleichbar zu machen, werden vier verschiedene Wandkonfigurationen $w_1, ..., w_4$ festgelegt. Dabei sind $w_1$ und $w_2$ kleine Wandkonfigurationen mit einer Breite von 80 cm und einer Höhe von 55 cm, wobei sie sich nur in dem horizontalen Versatz des Türausschnittes unterscheiden. Dafür werden ca. 32 @UE:pl:long benötigt. Wandkonfigurationen $w_3$ und $w_4$ sind größere Wände mit einer Breite von 2,1 m, einer Höhe von 1,05 m und ca. 75 @UE:pl:long, also Größen wie sie auch derzeit im @CBT herstellbar sind. Es werden pro Konfiguration jeweils vier Durchläufe aufgezeichnet, um die Ergebnisse gegenüber zufälligen Schwankungen robuster zu machen und deren Aussagekraft zu erhöhen.

Für nicht-deterministische Methoden, welche einen Zufallsgenerator benötigen, werden zwei Initialisierungswerte $s_1 = 1234$ und $s_2 = 84273915$ festgelegt, um die Ergebnisse in diesen Testläufen vergleichbar zu halten. Auch hier werden wieder je Wert vier Testläufe durchgeführt.
