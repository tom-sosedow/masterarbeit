...
Um die Ergebnisse vergleichbar zu machen, werden vier verschiedene Wandkonfigurationen $w_1, ..., w_4$ festgelegt. Dabei sind $w_1$ und $w_2$ kleine Wandkonfigurationen mit einer Breite von 80 cm und einer Höhe von 55 cm, wobei sie sich nur in dem horizontalen Versatz des Türausschnittes unterscheiden. Dafür werden ca. 32 @UE:pl:long benötigt. Durch manuelle Analyse konnten als optimal angenommene Routen für diese Wandkonfigurationen mit minimalen Kosten von jeweils 1 bestimmt werden. Wandkonfigurationen $w_3$ und $w_4$ sind größere Wände mit einer Breite von 2,1 m, einer Höhe von 1,05 m und ca. 75 @UE:pl:long, also Größen wie sie auch derzeit im @CBT herstellbar sind. Die händisch bestimmten optimalen Lösungen haben ebenfalls minimal erreichte Kosten von jeweils 1. Es werden pro Konfiguration jeweils vier Durchläufe aufgezeichnet, um die Ergebnisse gegenüber zufälligen Schwankungen robuster zu machen und deren Aussagekraft zu erhöhen.
