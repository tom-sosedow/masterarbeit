...
- an UE, an denen die hauptrichtung wechselt, fehlt definitiv eine regel zur korrekten bestimmung der umlaufrichtung
  ...
  - würde aber auch bei nicht-idealen routen fehlerhafte ergebnisse ausgeben
  - vielleicht könnte ansatz funktionieren, der achsenparallelität der resultierenden strebe(n) bewertet, da das das ausschlaggebende kriterium ist
- ein modell des garns unter spannung könnte die bestimmung z-Koordinaten der punkte präziser machen
...
// 5. Fazit
- innovativer ansatz 
- erzeugt unter der vorher gezeigten routenplanung garantiert gleichmäßige gitterstrukturen bis auf die ränder
