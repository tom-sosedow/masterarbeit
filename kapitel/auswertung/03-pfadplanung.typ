...
Vor diesem Hintergrund kann die Forschungsfrage (III) mit dem vorliegenden Ansatz nur eingeschränkt beantwortet werden. Zwar liefert das Verfahren in weiten Teilen valide Ergebnisse, jedoch ist keine gleichmäßige und strukturell konsistente Gitterstruktur garantiert, falls die Route nicht den Erwartungen und Voraussetzungen der Pfadplanung entspricht. Zur Ausbesserung dieser Limitationen sind daher weitere Untersuchungen notwendig.