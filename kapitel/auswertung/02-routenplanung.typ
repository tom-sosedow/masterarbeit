...
Mithilfe dieser Modellierung können beliebig viele Ausschnitte in der Wand dargestellt werden, indem die Anzahl und Position der Teilabschnitte angepasst werden.
...
// exakte Methoden
Aufgrund des durch diese Modellierung verkleinerten Suchraums wird der Einsatz exakter Suchalgorithmen wieder praktikabel, da diese unter den reduzierten Problemgrößen eine ausreichende Performanz aufweisen können. Bereits einfache Methoden wie Brute-Forcing liefern in diesem Kontext schnell sehr gute Ergebnisse, wie in @tab:bruteforce-puzzle-res zu sehen ist. Dabei garantieren sie weiterhin die Optimalität der Lösung. 
