...
Die im folgenden Abschnitt vorgestellte Lösungsmethode ist stark an die derzeit verwendete Methode des @CBT zur Berechnung der Positionen der @UE:pl:long angelehnt. Ansätze aus den anderen im vorherigen Abschnitt gezeigten Arbeiten können aufgrund diverser Inkompatibilitäten nicht übertragen werden. Es wird wieder iterativ vorgegangen, allerdings wird der Ablauf für die komplexeren Anforderungen erweitert und angepasst.
