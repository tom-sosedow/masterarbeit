  ...
  grid(
    ...
    [
      #cetz.canvas({
        ...
        line((-0.2,3*r), (0.2,3*r), stroke: (paint: red))
        line((-0.2,1*r), (0.2,1*r), stroke: (paint: red))
        line((0,1*r), (0,3*r), stroke: (paint: red))
      })
      (a) 
    ],
    [
      #cetz.canvas({
        ...
        // padding
        line((3*r, 6*r),(4*r, 6*r), stroke: (paint: red))
        line((3*r, 6*r + 0.2),(3*r, 6*r - 0.2), stroke: (paint: red))
        line((4*r, 6*r + 0.2),(4*r, 6*r - 0.2), stroke: (paint: red))
...
Wie in @sec:ue-place-problem dargestellt, existieren konzeptionell lediglich 32 zu betrachtende Kombinationen von Wanddimensionen. Der vorgestellte Ansatz wurde für sämtliche dieser Kombinationen empirisch getestet und anschließend evaluiert. In allen Fällen konnten vollständig korrekte und valide Platzierungen berechnet werden. Eine Beispielkonfiguration einer Wand mit den berechneten Positionen der @UE ist in @fig:fully-placed-ue-wall dargestellt. In dem gezeigten Beispiel ist kein Versatz der oberen @UE erforderlich.
