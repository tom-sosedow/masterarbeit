...
In dieser Arbeit wurde ein effizienter und zuverlässiger Ansatz zur Berechnung eines Roboterpfades entwickelt, um ein gleichmäßiges Gitter aus Carbonfasern zum Einsatz als Bewehrung für den Betonbau vollautomatisiert herstellen zu können. Dabei haben sich im Verlauf der Untersuchung neben wichtigen Erkenntnissen auch einige offene Fragen und mögliche Themen für weiterführende Forschungsarbeiten aufgetan. 

Ein möglicher Ansatz für zukünftige Arbeiten besteht in der Untersuchung einer kooperativen Platzierung der @UE, welche parallel oder nachgelagert zur Routen- oder Pfadplanung abläuft. Im Rahmen dieser Arbeit wurden die einzelnen Teilprobleme unabhängig voneinander betrachtet. Durch eine gemeinsame Optimierung könnte es jedoch möglich sein, die @UE gezielt so zu positionieren, dass sich günstigere Routen und gegebenenfalls kollisionsärmere Pfade ergeben.
...
Abschließend ergeben sich durch die geplante Weiterentwicklung des Garnablagewerkzeugs zusätzliche Anforderungen an die Pfadplanung. Ein präziseres Modell des Garns unter Spannung könnte dabei helfen, kritische Stellen entlang des Werkzeugpfades zu identifizieren und zu vermeiden. Nach der ingenieurstechnischen Anpassung des Werkzeuges wird dann ebenfalls eine Modifikation der Pfadgenerierung nötig, sodass hier weitere Untersuchungen zur Kollisionsvermeidung anzusetzen sind.
