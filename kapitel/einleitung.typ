...
Vor diesem Hintergrund wurde im Jahr 2022 das Carbonbetontechnikum Leipzig (CBT) als Modellfabrik für Forschung und Entwicklung in Betrieb genommen. Ziel ist es, die gesamte Prozesskette, also von der Herstellung der Carbonbewehrung bis zur Aushärtung des Betons, im Hinblick auf eine industrielle Umsetzung zu untersuchen. Ein besonderer Fokus liegt dabei auf der Entwicklung nachhaltiger und ressourcenschonender Bauweisen. Hierzu zählt insbesondere die vollautomatisierte Fertigung von Carbongelegen bei minimalem Materialverlust.

Im aktuellen Verfahren erfolgt die Ablage des Carbongarns durch einen Roboterarm, der das Material auf einem speziell konzipierten Rahmen verlegt. Dabei wird das Garn um an den Rändern positionierte zylindrische @UE:pl geführt. Durch eine speziell gewählte Folge von Bewegungen entsteht somit in einem Zug die gewünschte Bewehrungsmatte. Ein Beispiel für ein solches Carbongitter ist in @fig:carbongitter dargestellt.
