...
Die Laufzeit der implementierten Lösung spielt nur eine untergeordnete Rolle. Während der automatisierten Produktion erfordert die Ausführung der berechneten Produktionsschritte sowie die anschließende langwierige Temperierung im Ofen eines vorherigen Gitters aufgrund limitierter Produktionskapazitäten eine Unterbrechung von bis zu zwei Stunden, bevor mit der Herstellung einer neuen Bewehrung begonnen werden kann. In dieser Zeitspanne muss der zu entwickelnde Algorithmus eine Lösung generieren können, sodass nahtlos mit der nachfolgenden Produktion fortgefahren werden kann. Als Ziel wird deshalb angesetzt, die Laufzeit auf 30 Minuten zu begrenzen, um auch bei Effizienzsteigerungen der restlichen Produktion nicht als limitierender Faktor aufzutreten.
